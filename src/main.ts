...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle('Backend Gabinetes-Backups Proyecto Practicas UNSM')
    .setDescription('Documentation API REST Gabinetes-Backups Proyecto Practicas UNSM')
    .setVersion('1.0')
  ...
  SwaggerModule.setup('api/documentacion', app, document, {
    customSiteTitle: 'Documentación API REST Gabinetes-Backups Proyecto Practicas UNSM',
    customJs: [
